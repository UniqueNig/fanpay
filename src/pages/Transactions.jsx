    ...
    <DashboardLayout>
      <div className="p-5 lg:p-8 max-w-3xl">
        <div className="mb-7">
          ...
          <p className="text-ink/40 font-dm text-sm mt-1">Every deposit, transfer, and payment on your account</p>
        </div>
        ...
        <div className="card-flat overflow-hidden">
          {transactions.length === 0 ? (
            <div className="flex flex-col items-center justify-center py-16 px-6 text-center">
              ...
              <p className="text-ink/40 font-dm text-sm mb-5">Fund your wallet to get started</p>
              <Link
                to="/deposit"
