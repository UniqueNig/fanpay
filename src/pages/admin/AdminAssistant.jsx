...
const AdminAssistant = () => (
  <AdminLayout>
    <div className="p-5 lg:p-8 max-w-2xl">
      <div className="mb-6">
        <h1 className="font-syne font-bold text-ink text-2xl">Assistant</h1>
        <p className="text-ink/40 font-dm text-sm mt-1">AI-powered admin assistant</p>
      </div>
      <div className="card-flat p-10 text-center">
        <FiCpu className="text-ink/20 mx-auto mb-3" size={28} />
        <p className="text-ink/50 font-dm text-sm mb-2">Not set up yet</p>
