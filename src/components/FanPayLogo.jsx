...
const FanPayLogo = ({ className }) => (
  <svg viewBox="0 0 200 40" fill="none" className={className} role="img" aria-label="FanPay">
    <text fontFamily="Syne, sans-serif" fontWeight="800" fontSize="32" letterSpacing="-1">
      ...
      <tspan style={{ fill: "rgb(var(--fp-iris))" }}>Pay</tspan>
    </text>
  </svg>
);

export default FanPayLogo;
